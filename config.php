...
$dbuser = "cba7";//your ucid since we follow this pattern
$dbpass = "Chinemerem23!";//database password generated or chosen per respective steps
$dbdatabase = "cba7";//your ucid since we follow this pattern
?>
