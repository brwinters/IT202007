...
if (isset($id)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT survey.id,title,description,question_id,answer_id, user_id, Users.username FROM F20_Questions as F20_Answers JOIN Users on Survey.user_id = Users.id where Survey.id = :id");
